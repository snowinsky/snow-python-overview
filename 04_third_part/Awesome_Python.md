...
- [Awesome Python ](#awesome-python-)
  - [Admin Panels Admin管理面板，展示服务器状况等](#admin-panels-admin管理面板展示服务器状况等)
  ...
  - [CMS 内容管理系统，博客？](#cms-内容管理系统博客)
  - [Caching 缓存](#caching-缓存)
  - [ChatOps Tools 聊天机器人工具](#chatops-tools-聊天机器人工具)
  - [Code Analysis 代码静态分析和质量检测](#code-analysis-代码静态分析和质量检测)
  - [Command-line Interface Development 命令行接口开发](#command-line-interface-development-命令行接口开发)
  - [Command-line Tools 命令行工具](#command-line-tools-命令行工具)
  - [Computer Vision 计算机视觉，扫描二维码或者图片等](#computer-vision-计算机视觉扫描二维码或者图片等)
  - [Configuration Files 配置文件的存储和分析](#configuration-files-配置文件的存储和分析)
  - [Cryptography 密钥系统](#cryptography-密钥系统)
  - [Data Analysis 数据分析](#data-analysis-数据分析)
  - [Data Validation 数据内容验证](#data-validation-数据内容验证)
  - [Data Visualization 数据可视化](#data-visualization-数据可视化)
  - [Database 数据库](#database-数据库)
  - [Database Drivers 数据库驱动](#database-drivers-数据库驱动)
  - [Date and Time](#date-and-time)
  - [Debugging Tools](#debugging-tools)
  - [Deep Learning 深度学习](#deep-learning-深度学习)
  - [DevOps Tools](#devops-tools)
  - [Distributed Computing 分布式计算](#distributed-computing-分布式计算)
  - [Distribution 发布到不同的系统上](#distribution-发布到不同的系统上)
  - [Documentation 生成工程文档](#documentation-生成工程文档)
  - [Downloader 下载](#downloader-下载)
  - [Editor Plugins and IDEs 记事本插件和IDE](#editor-plugins-and-ides-记事本插件和ide)
  - [Email 电子邮件](#email-电子邮件)
  - [Environment Management 环境管理](#environment-management-环境管理)
  - [File Manipulation 文件操作](#file-manipulation-文件操作)
  - [Functional Programming 函数式编程](#functional-programming-函数式编程)
  - [GUI Development GUI开发](#gui-development-gui开发)
  - [GraphQL](#graphql)
...
## Admin Panels Admin管理面板，展示服务器状况等

*Libraries for administrative interfaces.*

* [ajenti](https://github.com/ajenti/ajenti) - The admin panel your servers deserve.  admin管理面板
* [django-grappelli](https://github.com/sehmaschine/django-grappelli) - A jazzy skin for the Django Admin-Interface. Django的admin接口的一个好看的皮肤
* [flask-admin](https://github.com/flask-admin/flask-admin) - Simple and extensible administrative interface framework for Flask. flask框架的一个扩展
* [flower](https://github.com/mher/flower) - Real-time monitor and web admin for Celery. Celery的实时监控和web admin服务
* [jet-bridge](https://github.com/jet-admin/jet-bridge) - Admin panel framework for any application with nice UI (ex Jet Django). 一个有很好的UT的admin管理面板框架
* [wooey](https://github.com/wooey/wooey) - A Django app which creates automatic web UIs for Python scripts.Django的自建web ui的脚本
* [streamlit](https://github.com/streamlit/streamlit) - A framework which lets you build dashboards, generate reports, or create chat apps in minutes. 一个框架，可以很容易的构建dashboard，report和chat app
...
* [attrs](https://github.com/python-attrs/attrs) - Replacement for `__init__`, `__eq__`, `__repr__`, etc. boilerplate in class definitions. 可以给class自动添加一下方便，类似于java中的lombok
* [bidict](https://github.com/jab/bidict) - Efficient, Pythonic bidirectional map data structures and related functionality.. 双向字典BiMap
* [box](https://github.com/cdgriffith/Box) - 字典与类之间互转
  ~~~python
  pip install python-box
  from box import Box
  dataDict = {'name': 'John', 'age': 30}
  box = Box(dataDict) #转类
  box.to_dict() #转字典
  ~~~
* [dataclasses](https://docs.python.org/3/library/dataclasses.html) - (Python standard library) Data classes. 注解，标注一个类是数据存储类型的类
* [dotteddict](https://github.com/carlosescri/DottedDict) - A library that provides a method of accessing lists and dicts with a dotted path notation. 定义了新的list或者dict能够用点路径来访问:比如dotteddict['key.value1.keyvalue1.keyvalue1value.....']
...
## ChatOps Tools 聊天机器人工具

*Libraries for chatbot development.*

* [errbot](https://github.com/errbotio/errbot/) - The easiest and most popular chatbot to implement ChatOps.

## Code Analysis 代码静态分析和质量检测
...
## Command-line Interface Development 命令行接口开发
...
## Computer Vision 计算机视觉，扫描二维码或者图片等
...
## Configuration Files 配置文件的存储和分析
...
## Data Validation 数据内容验证

*Libraries for validating data. Used for forms in many cases.*

* [cerberus](https://github.com/pyeve/cerberus) - A lightweight and extensible data validation library.
* [colander](https://github.com/Pylons/colander) - Validating and deserializing data obtained via XML, JSON, an HTML form post. Cerberus 使用 Python 字典来定义验证规则，其中键表示要验证的字段名称，值表示字段的验证规则
* [jsonschema](https://github.com/python-jsonschema/jsonschema) - An implementation of [JSON Schema](http://json-schema.org/) for Python.验证json格式的规则
* [schema](https://github.com/keleshev/schema) - A library for validating Python data structures. 验证数据的结构
* [schematics](https://github.com/schematics/schematics) - Data Structure Validation. 验证数据的结构
...
## Editor Plugins and IDEs 记事本插件和IDE
...
* [mimetypes](https://docs.python.org/3/library/mimetypes.html) - (Python standard library) Map filenames to MIME types.文件名到MIME type的映射
* [pathlib](https://docs.python.org/3/library/pathlib.html) - (Python standard library) An cross-platform, object-oriented path library. 面向对象的path库
* [path.py](https://github.com/jaraco/path.py) - A module wrapper for [os.path](https://docs.python.org/3/library/os.path.html). 对os.path的封装
* [python-magic](https://github.com/ahupp/python-magic) - A Python interface to the libmagic file type identification library.  可以检测和识别文件类型
* [watchdog](https://github.com/gorakhargosh/watchdog) - API and shell utilities to monitor file system events. 监控文件变化
...
*Libraries for geocoding addresses and working with latitudes and longitudes经纬度.*
